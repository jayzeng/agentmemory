...
export const COMMAND_DESCRIPTIONS: Record<(typeof COMMANDS)[number], string> = {
	...
	waitlist: "join the AgentMemory Pro beta waitlist without leaving the CLI",
...
export const OPTION_SPECS: Record<string, CliOptionSpec> = {
	...
	"--email": {
		description: "waitlist: email to submit non-interactively",
		value: { label: "address", kind: "value" },
	},
...
const COMMAND_USAGE: Record<string, string> = {
	...
	waitlist: "agent-memory waitlist [--email <address>] [--json]",
...
const COMMAND_EXAMPLES: Record<string, string[]> = {
	...
	waitlist: ["agent-memory waitlist", "agent-memory waitlist --email you@example.com --json"],
	uninstall: [
